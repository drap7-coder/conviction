...
- Portfolio Study Mode keeps each template’s design brief (principle, how it’s built, what breaks it, illustrative history, sleeve roles) plus target weights and a concentration compare vs the live book. Do not bring back Live “pressure points” insight cards.
