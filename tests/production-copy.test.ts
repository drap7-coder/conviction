...
describe("production copy and fixture isolation", () => {
  ...
  it("drops the News ProductStage count strip", () => {
    ...
    expect(feed).toContain("is-media-hero");
    ...
    expect(feed).toContain("Your Stocks");
    expect(feed).toContain("PRIMARY_FILTERS");
    ...
    expect(feed).toContain("priority={featured}");
    ...
    expect(newsCss).toContain(".pulse-news-narrative.is-media-hero");
    ...
    expect(newsCss).toContain(".pulse-news-filter-bar");
    expect(newsCss).toContain(".pulse-news-theme-menu");
    expect(newsCss).toContain("object-position: center");
    expect(newsCss).toContain("margin-inline: auto");
