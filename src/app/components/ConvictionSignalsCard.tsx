  ...
  return (
    ...
    >
      <summary className="company-sources-summary">
        <span className="company-sources-summary-label">Sources</span>
        <span className="company-sources-summary-copy">
          {expanded
            ? "Decision owns the read — open a lane only when you need the filing or tape detail."
            : "Filing lanes and tape detail — expand when you want to inspect evidence."}
        </span>
      </summary>
