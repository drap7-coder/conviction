...
export function MarketNarrativePulse({ pulse }: { pulse: MarketNarrativePulseData }) {
  return (
    <section className="market-panel narrative-panel" aria-label="Market narratives">
      <style>{`
        .narrative-panel { --narrative-blue:#2563eb; --narrative-purple:#7c3aed; --narrative-teal:#0f766e; --narrative-slate:#64748b; overflow:hidden; background:var(--card); }
        ...
        .narrative-card { --theme-accent:var(--narrative-slate); position:relative; min-width:0; overflow:hidden; padding:18px; border:1px solid color-mix(in srgb,var(--theme-accent) 12%,var(--border)); border-radius:12px; background:var(--card-inset); box-shadow:var(--shadow-sm); }
        ...
        .narrative-rank { margin-right:auto; color:color-mix(in srgb,var(--theme-accent) 82%,var(--market-text)); font-size:.56rem; font-weight:700; letter-spacing:.12em; }
        .narrative-heat,.narrative-tone { padding:5px 6px; border-radius:999px; color:var(--market-muted); background:color-mix(in srgb,var(--market-muted) 10%,transparent); font-size:.46rem; letter-spacing:.07em; text-transform:uppercase; }
        ...
        .narrative-tone.positive { color:var(--market-green); background:color-mix(in srgb,var(--market-green) 10%,transparent); }
        .narrative-tone.negative { color:var(--market-red); background:color-mix(in srgb,var(--market-red) 10%,transparent); }
        ...
        .narrative-metric { min-width:0; padding:9px 10px; border:1px solid color-mix(in srgb,var(--market-border) 65%,transparent); border-radius:8px; background:var(--card-inset); }
        ...
        .narrative-asset { display:inline-flex; gap:5px; padding:5px 6px; border:1px solid color-mix(in srgb,var(--market-border) 65%,transparent); border-radius:999px; color:var(--market-text); background:var(--card-inset); font-size:.49rem; font-variant-numeric:tabular-nums; }
        .narrative-asset .up { color:var(--market-green); }
        .narrative-asset .down { color:var(--market-red); }
        .narrative-headline { position:relative; display:block; min-height:67px; margin-top:14px; padding:11px 34px 11px 12px; border:1px solid color-mix(in srgb,var(--market-border) 65%,transparent); border-radius:8px; color:var(--market-text); background:var(--card-inset); font-size:.62rem; line-height:1.5; text-decoration:none; }
        ...
        .narrative-headline.empty { color:var(--market-muted); }
        .narrative-footer { display:flex; justify-content:space-between; gap:14px; margin-top:13px; color:var(--market-muted); font-size:.5rem; line-height:1.45; }
